# -*- coding: utf-8 -*-
#
# lpschedule-generator documentation build configuration file, created by
...
copyright = u'2016, lpschedule-generator contributors'
...
#html_title = u'lpschedule-generator v1'
...
htmlhelp_basename = 'lpschedule-generatordoc'
